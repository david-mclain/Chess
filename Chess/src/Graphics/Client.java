...
public abstract class Client {
	...
	public void promoteFrame(int i, int j) {
		...
		URL rookPath = loader.getResource("rook_" + color);
		JButton rook = new JButton(new ImageIcon(rookPath));
		...
		URL knightPath = loader.getResource("knight_" + color);
		JButton knight = new JButton(new ImageIcon(knightPath));
		...
		URL bishopPath = loader.getResource("bishop_" + color);
		JButton bishop = new JButton(new ImageIcon(bishopPath));
		...
		URL queenPath = loader.getResource("queen_" + color);
		JButton queen = new JButton(new ImageIcon(queenPath));
